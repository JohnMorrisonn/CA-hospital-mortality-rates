...
navbar = dbc.NavbarSimple(
    brand='CA Hospitals Mortality Rates',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('John Morrison', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:jjosephmorrison@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/JohnMorrisonn/CA-hospital-mortality-rates'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/johnjmorrison/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/John_J_Morrison'), 
                ], 
                className='lead'
            )
        )
